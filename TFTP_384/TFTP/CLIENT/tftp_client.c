...
void process_command(tftp_client_t *client, char command[])
{
    ...
    //     strcpy(client->server_ip, ip_addr);

    //     int ret = Ip_validation(ip_addr, port); // validate IP address and port number
    //     if (ret == 0)
    //         return;
    ...
    //         mode_flag = 2;
    //         Data_size = 8;
    //         strcpy(Req_packet.body.request.mode, "Octet");
    //         break;

    //     case 3:
    //         mode_flag = 3;
    //         strcpy(Req_packet.body.request.mode, "Net_ascii");
    //         break;
...
//     // int convert_netascii_2(int fd, char buff[]) // it will  return how many bytes readed
//     // {
//     //     int i = 0, j = 0;
//     //     int ret = 1;
//     //     char ch;
