...
// extern int Data_size ;  // to check mode of data tranmission
...
typedef struct {
    ...
    union {
        ...
        struct {
            uint16_t block_number;
            int Flag ;    //if flag =1 data received without error if 0 som eerror has occurred
...
int convert_netascii(int fd ,char buff[] );  
